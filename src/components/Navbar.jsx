  ...
  return (
    <div className="flex justify-between bg-black w-full h-20 ">
      ...
      <div className="flex bg-zinc-900   my-2 w-1/2 rounded-3xl">
        ...
        <button className="bg-zinc-800 pr-1 w-16 h-14 ml-20 my-1 rounded-sm">
          <PiDroneFill className="text-zinc-300 w-8 h-8 ml-4" />
          <p className="text-zinc-300  text-[12px] ml-1  font-semibold">
            Drones
          </p>
        </button>
        <button className=" w-16 h-14 ml-20 my-1 rounded-sm">
      ...
      <button className="flex bg-zinc-700 w-12 my-4 mr-4 h-12 rounded-full"></button>
    </div>
  );
};
